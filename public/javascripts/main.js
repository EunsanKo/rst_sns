	...
	if(!editing){
		$.get('/load',function(data){
			...
			$(data).each(function(i){
				...
				$("#wall .item:first .right").append("<div class='author'><b>"+this.author+"</b>("+this.date+")&nbsp;&nbsp;<span class='text_button modify'>MODIFY</span>&nbsp;&nbsp;<span class='text_buttion del'>DELETE</span>&nbsp;&nbsp;<span class='text_buttion like'>LIKE</span></div>");
				...
				$("#wall .item:first .modify").click(function(evt){
					editing = true;
					var contents = $("#wall .item:first .contents"+id).html();
					$("#wall .item:first .contents"+id).html("<textarea id='textarea_"+id+"' class='textarea_modify'>"+contents+"</textarea>");
